    ...
    "params": [
      {
        "name": "purpose",
        "in": "body",
        "type": "`clip-reference-image` \\| `clip-reference-video` \\| `clip-reference-audio` \\| `rebuild-still` \\| `element-image` \\| `visual-style-reference` \\| `ugc-demo` \\| `music` \\| `voice-sample` \\| `agent-attachment`",
        "required": true,
